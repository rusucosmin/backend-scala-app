...
dependencyOverrides in ThisBuild ++= Set(
  ...
  "com.twitter" % "finagle-base-http_2.11" % "6.41.0",
  "com.twitter" % "finagle-core_2.11" % "6.41.0",
  "com.twitter" % "finagle-exp_2.11" % "6.41.0",
  "com.twitter" % "finagle-http_2.11" % "6.41.0",
  "com.twitter" % "finagle-mux_2.11" % "6.41.0",
  "com.twitter" % "finagle-mysql_2.11" % "6.41.0",
  "com.twitter" % "finagle-netty4-http_2.11" % "6.41.0",
  "com.twitter" % "finagle-netty4_2.11" % "6.41.0",
  "com.twitter" % "finagle-stats_2.11" % "6.41.0",
  "com.twitter" % "finagle-thrift_2.11" % "6.41.0",
  "com.twitter" % "finagle-toggle_2.11" % "6.41.0",
  "com.twitter" % "finagle-zipkin-core_2.11" % "6.41.0",
  "com.twitter" % "finatra-http_2.11" % "2.7.0",
  "com.twitter" % "finatra-httpclient_2.11" % "2.7.0",
  "com.twitter" % "finatra-jackson_2.11" % "2.7.0",
  "com.twitter" % "finatra-slf4j_2.11" % "2.7.0",
  "com.twitter" % "finatra-utils_2.11" % "2.7.0",
  "com.twitter" % "inject-app_2.11" % "2.7.0",
  "com.twitter" % "inject-core_2.11" % "2.7.0",
  "com.twitter" % "inject-modules_2.11" % "2.7.0",
  "com.twitter" % "inject-request-scope_2.11" % "2.7.0",
  "com.twitter" % "inject-server_2.11" % "2.7.0",
  "com.twitter" % "inject-slf4j_2.11" % "2.7.0",
  "com.twitter" % "inject-utils_2.11" % "2.7.0",
  "com.twitter" % "libthrift" % "0.5.0-7",
  "com.twitter" % "scrooge-core_2.11" % "4.13.0",
  "com.twitter" % "twitter-server_2.11" % "1.26.0",
  "com.twitter" % "util-app_2.11" % "6.40.0",
  "com.twitter" % "util-cache_2.11" % "6.40.0",
  "com.twitter" % "util-codec_2.11" % "6.40.0",
  "com.twitter" % "util-collection_2.11" % "6.41.0",
  "com.twitter" % "util-core_2.11" % "6.41.0",
  "com.twitter" % "util-events_2.11" % "6.40.0",
  "com.twitter" % "util-function_2.11" % "6.41.0",
  "com.twitter" % "util-hashing_2.11" % "6.40.0",
  "com.twitter" % "util-jvm_2.11" % "6.40.0",
  "com.twitter" % "util-lint_2.11" % "6.40.0",
  "com.twitter" % "util-logging_2.11" % "6.40.0",
  "com.twitter" % "util-registry_2.11" % "6.40.0",
  "com.twitter" % "util-stats_2.11" % "6.40.0",
